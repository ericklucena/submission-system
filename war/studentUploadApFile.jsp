				...
				<div class="l-box">
					<div class="panel panel-default">
						<div class="panel-heading">
							<h3 class="panel-title">Submissão de aula prática</h3>
						</div>
						<div class="panel-body">
							<div class="l-box">
							<%
								if(SubmissionSystem.getInstance().isRunning(SystemConstants.APSERVER)){
							%>

								<form class="form-horizontal" action="<%=blobstoreService.createUploadUrl("/uploadAp")%>" method="post" enctype="multipart/form-data">
									<div class="form-group">
										<label for="lista" class="col-sm-2 control-label">Questão</label>
										<div class="col-sm-4">
											<select class="form-control" name="lista" id="lista">
											<%
												Status status = SubmissionSystem.getInstance().searchServerStatus(SystemConstants.APSERVER);
